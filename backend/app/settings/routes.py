...
# Kept in sync with PLAN_CONFIG in app/billing/routes.py.
# See CLAUDE.md "Cost rationale" before changing any number.
PLAN_LIMITS = {
    "free": {
        "name": "Free",
        "assetLimit": 2,
    ...
    "starter": {
        ...
        "membersLimit": 5,
        "apiKeysLimit": 3,
        "features": ["All Scan Profiles", "Scheduled Scans", "API Access", "Weekly Monitoring"],
        "price": 19,
    },
    "professional": {
        "name": "Professional",
        ...
        "membersLimit": 20,
        "apiKeysLimit": 10,
        "features": ["Everything in Starter", "Priority Scanning", "Deep Discovery", "Webhooks"],
        "price": 99,
    },
    "enterprise_silver": {
        ...
        "membersLimit": 100,
        "apiKeysLimit": -1,
        "features": ["Everything in Professional", "Daily Monitoring", "Audit Log", "Priority Support"],
        "price": 499,
    },
    "enterprise_gold": {
    ...
    "enterprise": {
        ...
        "membersLimit": 100,
        "apiKeysLimit": -1,
        "features": ["Everything in Professional", "Daily Monitoring", "Priority Support"],
        "price": 499,
    },
}
