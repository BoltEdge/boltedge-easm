          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 max-w-6xl mx-auto">
              {[
                ...
                { name: "Enterprise Silver", price: "A$599", period: "/mo", desc: "For organisations at scale", limits: ["10,000 assets","6,000 scans / month","200 discoveries / month","Monitor up to 100 assets daily","50 team members","100 scheduled scans","10 API keys","Webhooks & integrations","Deep discovery"], excluded: [], cta: "Request free trial", href: "/?type=trial#contact", highlight: false, trial: true, annual: "A$509/mo billed annually" },
                { name: "Enterprise Gold", price: "A$999", period: "/mo", desc: "Full featureset for serious teams", limits: ["20,000 assets","12,000 scans / month","400 discoveries / month","Monitor up to 250 assets daily","100 team members","200 scheduled scans","20 API keys","Audit log","Priority support"], excluded: [], cta: "Request free trial", href: "/?type=trial#contact", highlight: false, trial: true, annual: "A$849/mo billed annually" },
