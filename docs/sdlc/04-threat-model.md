...
| T-04 | Phishing site mimicking `nanoasm.com` to harvest credentials | S | Medium | High | **High** | M-11: HSTS + DNS CAA record limits which CAs can issue for our domain. M-12 (out-of-platform): user education in onboarding email. M-13 (planned): MFA reduces value of harvested passwords. |
